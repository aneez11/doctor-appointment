                ...
                <td>
                    <div class="btn-group btn-group-sm">
                        ...
                        <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#checkupEdit"
                            ...
                            data-bs-prescriptions="{{ $checkup->prescriptions }}">Edit</button>
                        @endrole
...
{{-- checkupCreate --}}
<div class="modal fade" id="checkupCreate" tabindex="-1" data-bs-backdrop="static" aria-labelledby="addReportModalLabel"
...
{{-- Completed --}}
<div class="modal fade" id="markCompleted" tabindex="-1" data-bs-backdrop="static" aria-labelledby="addReportModalLabel"
    data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
